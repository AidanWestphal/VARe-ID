...
def parse_config(filepath):
    ...
    dt_out_path = os.path.join(dt_dir, config["dt_out_file"])
    ...
    ia_filtered_out_path = os.path.join(ia_dir, config["ia_filtered_out_path"])
    ia_logs = os.path.join(log_dir, config["ia_logfile"])

    # FRAME SAMPLING STEP
    fs_dir = os.path.join(out_dir, config["fs_dirname"])
    fs_out_path = os.path.join(fs_dir, config["fs_out_path"])
    ...
    config["dt_out_path"] = dt_out_path
