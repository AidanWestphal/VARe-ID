...
from GGR.util.io.logging import setup_logging, log_subprocess
...
def main(args):
    ...
    command = f'python -u -m GGR.algo.import.import_images {config["data_dir_in"]} {config["image_out_path"]}'
