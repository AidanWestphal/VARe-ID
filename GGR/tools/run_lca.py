...
try:
    ...
    result = subprocess.run(
        f"python algo/lca.py {lca_dir} {lca_out_dir} {fs_out_final_path} {mid_out_path} {lca_verifiers_path} {lca_db_dir} {lca_logs_path} {lca_exp_name} {lca_alg_name} {lca_sep_viewpoint} &> {lca_logs}",
