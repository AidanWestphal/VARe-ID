...
def main(args):
    ...
    command = f'python -u -m VAREID.algo.detection.image_detector {config["image_out_path"]} {config["dt_dir"]} {config["dt_model_path"]} {config["dt_image_out_path"]} {config["cp_freq"]} {config["dt_cp_path"]} {gt_filtered_annots} {gt_path}'
